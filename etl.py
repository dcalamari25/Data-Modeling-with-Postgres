...
def process_log_file(cur, filepath):
    ...
    # implement the time_table_insert query
    for i, row in time_df.iterrows():
        cur.execute(time_table_insert, list(row))

    # load user table
    user_df = t.filter(['userId', 'firstName', 'lastName', 'gender', 'level'])
